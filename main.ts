...
function giveIntroduction () {
    ...
    game.setDialogCursor(img`
        ...
        . . . . . . . . . . . . . . . . 
        `)
    showInstruction("Muévete con las flechas o el joystick.")
    showInstruction("Salta con la flecha arriba o el botón \"A\".")
    showInstruction("Doble salto presionando saltar 2 veces seguidas.")
}
